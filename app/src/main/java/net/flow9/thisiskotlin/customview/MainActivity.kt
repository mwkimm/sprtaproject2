...
import net.flow9.thisiskotlin.customview.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter.itemClick = object : MyAdapter.ItemClick {
            override fun onClick(view: View, position: Int) {
                ...
                // 온클릭 메서드 밖에서 선언 알아서 메인엑티비티 찾아감, 온 클릭 안에 들어오는순간 main인지 온클릭 인지몰라서 @를 붙여서 명시
                val intent = Intent(this@MainActivity, DetailActivity::class.java)

                val product: String = dataList[position].Product
        ...
        binding.fbScrollup.setOnClickListener {
            binding.recyclerView.smoothScrollToPosition(0) // 천천히
            //binding.recyclerView.scrollToPosition(0) // 한번에
        }
